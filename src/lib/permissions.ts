import type { Board, BoardPermissions, PermissionScope, OperationType } from './types.js';
...
export function hasPermission(
	...
	return getPermissionStatus(userDid, boardOwnerDid, ownerTrustedDids, permissions, operation, columnId) === 'allowed';
}
